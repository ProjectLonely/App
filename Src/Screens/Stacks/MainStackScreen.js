        ...
        >
            <Tab.Screen
                ...
                options={{
                    ...
                    tabBarIcon: ({ color, focused }) => (
                        <Icon name="home-outline" size={20} style={[styles.icon, { color: color }]} />
                    ),
                }}
            />
            <Tab.Screen
                ...
                options={{
                    gestureEnabled: false,
                    tabBarIcon: ({ color, focused }) => (
                        <Icon name="people-outline" size={22} style={[styles.icon, { color: color }]} />
                    ),
                }}
            />
            ...
            <Tab.Screen
                ...
                options={{
                    abBarLabel: "",
                    tabBarIcon: ({ color, focused }) => (
                        <Icon name="call-outline" size={20} style={[styles.icon, { color: color }]} />
                    ),
                }}
            />
            <Tab.Screen
                ...
                options={{
                    abBarLabel: "",
                    tabBarIcon: ({ color, focused }) => (
                        <Icon name="settings-outline" size={20} style={[styles.icon, { color: color }]}
                        />
                    ),
